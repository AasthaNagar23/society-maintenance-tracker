...
function AdminDashboard() {
  ...
  async function fetchData() {
    try {
      ...
      const [
        ...
        fetch(`${API_URL}/admin/maintenance`, {
          headers,
        }),
        fetch(`${API_URL}/admin/residents`, {
          headers,
        }),
      ]);
  ...
  async function updatePriority(id, newPriority) {
    try {
      const response = await fetch(
        `${API_URL}/admin/complaints/${id}/priority?priority=${encodeURIComponent(
          newPriority
        )}`,
        {
          method: "PUT",
          ...
          <div className="admin-hero-content">
            ...
            <div className="hero-actions">
              <button
                ...
                onClick={() => {
                  window.location.href = "/create-maintenance";
                }}
              >
                <span>+</span>
                Create Maintenance
